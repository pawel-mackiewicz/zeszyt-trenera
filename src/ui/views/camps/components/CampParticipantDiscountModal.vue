...
import {
  ...
  type CampParticipantDiscountSubmit
} from './campParticipantActionModalUtils'

type FormErrorKey = 'invalidDiscount'
...
const emit = defineEmits<{
  close: []
  submit: [payload: CampParticipantDiscountSubmit]
}>()
...
function submitDiscount() {
  const amount = parsePositiveMoney(discountAmount.value, props.currency)
  ...
  emit('submit', {
    amount,
    reason: optionalText(discountReason.value)
  })
}
</script>
